...
export function CruiseItineraryTable<TData, TValue>({
  columns,
  data,
    ...
    <div className="rounded-md text-darkElement dark:text-lightElement">
      <div className="flex items-center py-4">
        <Input
          ...
          value={(table.getColumn("cruise")?.getFilterValue() as string) ?? ""}
          onChange={(event) =>
            table.getColumn("cruise")?.setFilterValue(event.target.value)
          }
          className="max-w-sm"
        />
      </div>
